...
export const COMMENT_TAG =
  '<!-- This is an auto-generated comment by the Ironhack bot -->'

export const COMMENT_REPLY_TAG =
  '<!-- This is an auto-generated reply by the Ironhack bot -->'

export const SUMMARIZE_TAG =
  '<!-- This is an auto-generated comment: summarize by the Ironhack bot -->'

export const IN_PROGRESS_START_TAG =
  '<!-- This is an auto-generated comment: summarize review in progress by the Ironhack bot -->'

export const IN_PROGRESS_END_TAG =
  '<!-- end of auto-generated comment: summarize review in progress by the Ironhack bot -->'

export const DESCRIPTION_START_TAG =
  '<!-- This is an auto-generated comment: release notes by the Ironhack bot -->'
export const DESCRIPTION_END_TAG =
  '<!-- end of auto-generated comment: release notes by the Ironhack bot -->'

export const RAW_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: raw summary by the Ironhack bot -->
<!--
`
export const RAW_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: raw summary by the Ironhack bot -->`

export const SHORT_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: short summary by the Ironhack bot -->
<!--
`

export const SHORT_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: short summary by the Ironhack bot -->`
